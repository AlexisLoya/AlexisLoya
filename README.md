...
Construyo **backends en Python/Django**, APIs REST y sistemas empresariales escalables, con foco en **arquitectura**, **microservicios** y **IA/analítica aplicada** a productos web (dashboards, automatización y procesamiento de datos).

---

## Capabilidades (UX/Tech Dashboard)

<div align="center">
  <img height="55" src="https://skillicons.dev/icons?i=python,django,fastapi,postgres,redis,celery,docker,linux,nginx,git,github&theme=dark" alt="Tech stack backend" />
</div>

<div align="center" style="margin-top:6px">
  <img height="55" src="https://skillicons.dev/icons?i=react,vue,typescript,javascript&theme=dark" alt="Tech stack web frontend" />
</div>
...
- **Enterprise Management System – Sekisui**: Django + DRF + PostgreSQL; **KPI dashboard en tiempo real**, colas con **Celery/Redis**, integración con **Microsoft Graph** y almacenamiento con **SFTP**.
- **Subscription Management Platform**: **Stripe/PayPal**, autenticación con **JWT/OAuth2**, panel de administración y API REST para web y móvil.
- **Sistemas internos**: gestión de proyectos/claims y flujo de archivos con énfasis en **seguridad**, **auditoría** y **escalabilidad**.
...
<img src="https://i.imgur.com/L6sxZby.gif" alt="Decoración" width="120" />

*Siempre abierto a colaborar en backend, plataformas web y soluciones con IA.*
